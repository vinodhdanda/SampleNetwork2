...
public class ByteArrayUtils {
    ...
    public static void writeInt( byte[] p_dest,  
				 int    p_toWrite )
    {
	//if( p_dest.length >= SIZE_OF_AN_INT_IN_BYTES ): "Programming error: p_dest is too short to hold an int";
    ...
    {
	//if (assert( p_src.length >= SIZE_OF_AN_INT_IN_BYTES )) : "Programming error: p_src is too short to hold an int";
